...
\begin{bibenum}
   \item A.Y.~Kim, C.~Ismay, J.~Chunn. (2017) The fivethirtyeight R Package: "Tame Data" Principles for Introductory Statistics and Data Science Courses.
   \item T.~Singh, A.Y.~Kim. (2017) Regression and Matching for Causal Inference.
...
%----------------------------------------------------------------------%
\vspace{0.1in}
\section{Panels and Workshops Led}
