...
\begin{outerlist}
    \item[] Assistant Professor of Statistics, Mathematics Department
		...
		\item[$\circ$] Introduction to Data Science (MATH 216, new course): Analysing large and complex data sets using advanced statistial software tools.
...
\begin{outerlist}
    ...
    \begin{innerlist}
		...
		\item[$\circ$] Case Studies in Statistical Analysis (MATH 241, new course):  Analysing large and complex data sets using advanced statistial software tools.
	\end{innerlist}
    \end{innerlist}
\end{outerlist}
...
\begin{innerlist}
	...
	\item Senior Thesis (co-advised with B. Thomas): Carl Proepper, ``Generalized
...
\begin{innerlist}
	\item Programming languages: C, C++, Python, MySQL, Java, Julia.
...
\begin{innerlist}
	...
	\item (Invited) Park City Mathematics Institute Summer Session Faculty Program on establishing a curriculum for Data Science, Midway UT, July 2016.
	\item Big Data: Implications for the Liberals Arts Curriculum, Wellesley College, Wellesley MA, January 2016. 
...
\begin{innerlist}
	...
	Williams and Middlebury Colleges (co-lead with Prof. E. Proctor), 2016.
