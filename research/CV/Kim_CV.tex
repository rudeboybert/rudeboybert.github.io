...
\begin{outerlist}
    ...
    \begin{innerlist}
		\item Courses taught:
		\begin{innerlist}
		\item[$\circ$] STAT 390 Statistics for Engineers and Scientists:
		Introductory statistics for non-statistics science and engineering majors	\end{innerlist}
    \end{innerlist}
\end{outerlist}
...
\begin{outerlist}
    ...
    \begin{innerlist}
		\item Courses taught:
		\begin{innerlist}
		\item[$\circ$] STAT 220 Basic Statistics:  Introductory
...
% Reference for Jacob Menick, Philip Stallworth, Liam Bowcock, Bryan Kim, 
% Kevin Gallagher, Johannes Harkins
% Adriana Escobedo-Land, Torrey Payne, Tristan Hechtel, Julie Martin, 
% Jed Grabman,
...
\begin{innerlist}
	...
	measure theoretic probability, 2015.
	\item Paper: Adriana Escobedo-Land, ``OkCupid Profile Data for Intro 
	Stats and Data Science Courses'', 2015
	\item Summer Science Research Fellowship: Jacob Menick, ``Evaluating Latent 
	Dirichlet Allocation Topics'', 2014.
	\item Thesis: Kevin Gallagher, ``Building a Better Mortgage-Backed Security:
	Correctly Pricing Associated Risks'', 2014.
	\item Thesis: Tristan Hechtel ``Pay It Forward'' Tuition: An Econometric 
	Analysis'', 2014.
	\item Thesis: Torrey Payne, ``The Generalist Bias: Estimating the 
	Value of Three-Point Shooting in the National Basketball Association'', 2014.
	\item Thesis: Joan Wang, ``Food Hinterlands: The Sprawling of 
	Food Deserts'', 2014.
\end{innerlist}
...
\begin{innerlist}
	\item Programming languages: C, Python, MySQL, Java, Julia.
    \item Operating systems: UNIX, Mac OS X, Windows.
    \item Applications: R, Git, MATLAB, MapReduce.
    ...
    \begin{innerlist}
		...
		\item[$\circ$] \verb#resampledata#: Package of data sets from ``Mathematical
		Statistics with Resampling in R'' by Chihara and Hesterberg.
	\end{innerlist}
	\item Contributor to \verb#oilabs# \verb#R# package of data and code 
	necessary for R labs accompanying OpenIntro textbook.
\end{innerlist}
...
\begin{innerlist}
    ...
    %An Approach to Expose Undergraduates to Authentic Data Analysis Processes
    ...
    % Using Visualization as a Gateway Drug to Statistics in Week One
\end{innerlist}
...
\begin{innerlist}
    \item Volunteer OpenIntro open-source introductory statistics textbook \href{https://www.openintro.org/}{https://www.openintro.org/}
    \item Organizing committee, 2016 ASA DataFest
\end{innerlist}
...
\begin{innerlist}
	\item Calculus
	\item (Invited) PCMI
	\item Big Data in the Liberals Arts Curriculum
	\item Advanced R
\end{innerlist}
...
\begin{innerlist}
	\item Faculty lead for Green Chicken student math competition between 
	Williams and Middlebury Colleges (with E. Proctor), 2016
	\item Faculty lead for R Community of Practice for Middlebury faculty, 2016-present.
	%\item Creator of Middlebury College data science minor, 2016
	\item Co-organizer of inaugural ASA DataFest Vermont (with P. Yates), 2016
	\item Co-creator of Reed College statistics concentration within mathematics
	major (with A. Jones), 2015
\end{innerlist}
...
\begin{innerlist}
	...
	\item Interests: American history, hiking, standup paddleboarding, hockey, skiing, bicycling, and backcountry camping.
\end{innerlist}
