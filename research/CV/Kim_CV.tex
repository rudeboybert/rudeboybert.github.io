...
\begin{innerlist}
	...
	\item Thesis: Blake Rosenthal, ``Mapping Oregon Groundwater: A
	Geo-Statistical Anaylsis in Spatial Interpolation'', 2015
	\item Thesis (co-advised with B. Thomas): Carl Proepper ``Generalized
...
\begin{innerlist}
  %\item Who we are as faculty. Middlebury Writing Retreat
...
\begin{innerlist}
	...
	\item Advanced R
	\item New Researchers Conference
	\item Foss4G OpenStreetMaps Sept 2014
\end{innerlist}
...
\begin{innerlist}
	...
	\item Interests: American history, hiking, standup paddleboarding,
