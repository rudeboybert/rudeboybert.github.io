...
> 1. ID variables in left-hand columns
> 1. Clean dates (More generally: clean numerical representations)
...
Examples are in R, so I suggest you follow in HTML version of this talk available at <a target="_blank" class="page-link" href="http://bit.ly/causeweb_tame">bit.ly/causeweb_tame</a>
...
# only first 10 columns of dataset:
bob_ross %>% 
  select(1:10) %>% 
  sample_n(3)
```
...
* `fivethirtyeight` package used in other contexts:
    ...
    1. Advanced R package development project
...
> * Internship model of learning/development: learning [R package construction](http://r-pkgs.had.co.nz/), [GitHub](http://happygitwithr.com/), communication and project management skills, etc.
> * RStudio's 2018 [`broom` package summer internship](https://blog.rstudio.com/2018/04/18/summer-interns/) follows a similar model. 
